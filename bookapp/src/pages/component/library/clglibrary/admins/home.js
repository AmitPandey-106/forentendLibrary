...
export async function getServerSideProps() {
  const res = await fetch("https://backendlibrary-2.onrender.com/all-members");
  const data = await res.json();

  const res2 = await fetch("https://backendlibrary-2.onrender.com/all-books");
  const data2 = await res2.json();

  const res3 = await fetch('https://backendlibrary-2.onrender.com/all-borrow-books');
...
export default function HomePage({ memberLength, bookslen, allborrowed }) {
  ...
  useEffect(() => {
    const fetchMostBorrowedBooks = async () => {
      try {
        const response = await fetch("https://backendlibrary-2.onrender.com/most-borrowed"); // Replace with your API endpoint
  ...
  const fetchTommorow = async () => {
    try {
      setLoading(true);
      const response = await fetch("https://backendlibrary-2.onrender.com/tmr-due-books");
  ...
  const fetchDueBooks = async () => {
    try {
      setLoading(true);
      const response = await fetch("https://backendlibrary-2.onrender.com/today-due-books");
      const data = await response.json();
